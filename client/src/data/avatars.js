...
export const PREMIUM_AVATARS = [
  ...
  { emoji: "🦸", name: "Kahraman",    glow: "#3b82f6", anim: "glow-blue"    },
  { emoji: "🧙", name: "Sihirbaz",    glow: "#a855f7", anim: "glow-purple"  },
  { emoji: "🌋", name: "Volkan",      glow: "#ef4444", anim: "glow-red"     },
  { emoji: "☄️", name: "Meteor",      glow: "#f97316", anim: "glow-orange"  },
  { emoji: "🔱", name: "Triton",      glow: "#0ea5e9", anim: "glow-cyan"    },
  { emoji: "⚜️", name: "Asalet",      glow: "#ffd700", anim: "glow-gold"    },
  { emoji: "🌌", name: "Galaksi",     glow: "#6366f1", anim: "glow-indigo"  },
  { emoji: "🤖", name: "Robot",       glow: "#06b6d4", anim: "glow-cyan"    },
  { emoji: "🐯", name: "Kaplan",      glow: "#f97316", anim: "glow-orange"  },
  { emoji: "🦈", name: "Köpekbalığı", glow: "#0ea5e9", anim: "glow-blue"    },
  { emoji: "🏯", name: "Kale",        glow: "#94a3b8", anim: "glow-grey"    },
];
